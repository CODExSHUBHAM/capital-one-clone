    ...
    <>
      ...
      <section className="w-screen overflow-x-hidden">
        ...
        <div className="flex flex-col items-center py-10 md:py-20 space-y-4 w-11/12 m-auto md:w-auto text-center">
          <h1 className="text-4xl font-light md:text-5xl">Get deals on small business essentials</h1>
          <p className="text-lg md:text-xl">Joining is <b>easy</b> and <b>free</b></p>
          <p className="text-lg md:text-xl">No Capital One account required.</p>
          <Link to='/signup' className="text-xl bg-[#25810E] rounded-md font-semibold text-white px-4 py-3 w-full md:w-auto">Start Saving</Link>
        </div>
        ...
        <div className="flex flex-col space-y-6">
          ...
          <Link to='/deals' className="text-base text-blue-500 font-semibold self-center">View All Deals &gt;</Link>
        </div>
        ...
        <div className="bg-[#013D58]">
          <div className="w-4/5 m-auto flex flex-col justify-center items-center space-y-10 py-16">
            ...
            <div className="overflow-x-scroll md:overflow-x-auto">
              ...
              <Link to='/signup' className="w-full md:w-auto text-xl bg-[#25810E] rounded-md font-semibold text-white px-4 py-3">Get Free Deals</Link>
          </div>
        </div>
